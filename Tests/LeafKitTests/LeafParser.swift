...
final class Leaf4ParserTests: LeafTestClass {
    func testParser() throws {
        ...
        let start = Date()
        var sampleParse = try! Leaf4Parser(name: "s", tokens: lex(sample))
    ...
    func testEval() throws {
        ...
        do {
            sampleParse = try Leaf4Parser(name: "s", tokens: lex(sample))
