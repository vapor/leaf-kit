...
internal struct CollectionToIntMap: LeafMethod {
    static var callSignature: [CallParameter] { [.types(.collections)] }
...
internal struct CollectionElementToBoolMap: LeafMethod {
    static var callSignature: [CallParameter] { [.types(.collections), .types(.any)] }
    static var returns: Set<LeafDataType> { [.bool] }
    static let invariant: Bool = true
...
internal struct StrToStrMap: LeafMethod {
    static var callSignature: [CallParameter] = [ .types([.string]) ]
...
internal struct StrStrToBoolMap: LeafMethod {
    static var callSignature: [CallParameter] = [ .types([.string]), .types([.string]) ]
    static var returns: Set<LeafDataType> { [.bool] }
    static let invariant: Bool = true
...
internal struct DictionaryCast: LeafFunction {
    static let callSignature: [CallParameter] = [.types([.dictionary])]
